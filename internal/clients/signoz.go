...
import (
	...
	clusterv1beta1 "github.com/facilitygrid/provider-signoz/apis/cluster/v1beta1"
	namespacedv1beta1 "github.com/facilitygrid/provider-signoz/apis/namespaced/v1beta1"
)
...
func TerraformSetupBuilder(version, providerSource, providerVersion string) terraform.SetupFn {
	return func(ctx context.Context, client client.Client, mg resource.Managed) (terraform.Setup, error) {
		...
		// The SigNoz TF provider requires endpoint and access_token.
